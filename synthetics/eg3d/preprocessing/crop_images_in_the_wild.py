...
import numpy as np
import sys
sys.path.append('../deep_3d_face_recon')
from synthetics.deep_3d_face_recon.util.load_mats import load_lm3d
from synthetics.deep_3d_face_recon.util.preprocess import align_img
...
if __name__ == '__main__':
    ...
    lm3d_std = load_lm3d("../deep_3d_face_recon/BFM/") 
